...
<div style="width: 80%; margin: auto;">
    ...
    <p>
        ...
        <?php endif; ?>
        <form class="form-inline form-publish" method="POST" action="<?= action('Admin\AdminController@postPublishTranslations', $group) ?>" data-remote="true" role="form" data-confirm="Are you sure you want to publish the translations group '<?= $group ?>? This will overwrite existing language files." style="margin-top: 10px;">
            <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
            <button type="submit" class="btn btn-info" data-disable-with="Publishing.." style="background-color: #fa5b0f; border-color: #fa5b0f;">Save angular translations</button>
        </form>
    </p>
    <form role="form">
        <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
