...
<link href="/css/admin/jobs.css" rel="stylesheet" type="text/css" />
	<div class="row-fluid">
        <div class="span12">
        	<a href="{{url('/admin/create-job')}}" type="button" class="btn btn-success create-button">Create Job</a>
            ...
            <div class="portlet box blue-chambray">
                ...
                <div class="portlet-body no-more-tables">
                    ...
                    <table class="table table-bordered table-hover responsive-table">
                            ...
                            <tbody>
                                @foreach ($search_results as $key => $job)
                                    <tr>
                                        <td>{{$key + 1}}</td>
                                        <td>{{$job->name}}</td>                                        
                                        <td>
                                        <a href="{{URL::to('/admin/show-job',$job->id)}}" type="button" class="btn btn-info">
                                            <i class="fa fa-book"></i> Show </a>
                                        </td>
                                        <td>
                                        <a href = "{{URL::to('/admin/edit-job',$job->id)}}" type="button" class="btn btn-primary" >
                                        	<i class="fa fa-edit"></i> Update </a>
                                        </td>
                                        <td>
                                        <a type="button" data-toggle="modal" data-target = "#job_delete" href="#small" alt="{{$job->id}}" class="btn btn-danger show_modal_job">
