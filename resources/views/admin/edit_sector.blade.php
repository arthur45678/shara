...
<div class="portlet box blue-chambray">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-gift"></i>Update Industry
        </div>
        <div class="tools">
	...
	<form method="post" files = "true" class="form-horizontal" id="create-user-form" action="{{action('Admin\SectorController@postEditSector')}}">
        {{csrf_field()}}
            ...
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="checkbox" class="form-control check-box" name="activate" id="activate" @if($sector->activation == 'activated') checked @endif/>
