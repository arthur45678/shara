...
$countries[] = array("code"=>"RE","name"=>"Réunion-Mayotte" ,"d_code"=>"+262");
$countries[] = array("code"=>"RO","name"=>"Romania","d_code"=>"+40");
$countries[] = array("code"=>"RU","name"=>"Russia-Kazakistan","d_code"=>"+7");
...
$countries[] = array("code"=>"RS","name"=>"Serbia-Kosovo","d_code"=>"+381");
